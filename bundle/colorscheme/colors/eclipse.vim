...
" Liang Feng <fliang98 AT gmail DOT com>
highlight Normal gui=none guifg=#000000 guibg=#80a0b0 ctermfg=Gray

" Search
highlight IncSearch gui=none guifg=#404040 guibg=#e0e040
...
highlight CursorLine gui=none guibg=#BFB7AD

" Fold
" Liang Feng <fliang98 AT gmail DOT com>
highlight Folded     gui=none guibg=LightBlue3 guifg=NONE ctermbg=black ctermfg=black cterm=bold
highlight FoldColumn gui=none guifg=#6b6b6b guibg=#e7e7e7 ctermfg=black ctermbg=white

" Popup Menu
highlight Pmenu guifg=white guibg=#a4a2a0 ctermbg=green ctermfg=white
...
highlight NonText    gui=none guifg=#dcd8d8
highlight SpecialKey gui=none guifg=#ff0000 guibg=bg      cterm=none       ctermfg=4
...
" highlight Function   gui=none guifg=#808080 guibg=bg      ctermfg=White
" highlight Function   gui=none guifg=#404040 guibg=bg      ctermfg=White
